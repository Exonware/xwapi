#!/usr/bin/env python3
"""
#exonware/xwapi/src/exonware/xwapi/client/builtin_entity_session_manager.py
Built-in entity session manager (same behavior as ``exonware.xwlogin.clients.entity_session_manager``).

Shipped inside xwapi so agents do not depend on xwauth/xwlogin. Prefer injecting a provider when you
...
class EntitySessionManager:
    ...
    def start_all_sessions(self, session_factory: Optional[Callable[[], Any]] = None) -> None:
        """
