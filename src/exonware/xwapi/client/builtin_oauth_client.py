#!/usr/bin/env python3
"""
#exonware/xwapi/src/exonware/xwapi/client/builtin_oauth_client.py
Built-in OAuth2 client manager (same behavior as ``exonware.xwlogin.clients.oauth_client``).

Shipped inside xwapi so agents do not depend on xwauth/xwlogin.
